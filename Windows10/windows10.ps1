...
if (($App.Name -in "Microsoft.WindowsCalculator","Microsoft.WindowsStore","Microsoft.Appconnector","Microsoft.MicrosoftStickyNotes")) {
...
Set-PolicyFileEntry -Path $env:systemroot\system32\GroupPolicy\Machine\registry.pol -Key "System\CurrentControlSet\Policies" -ValueName NtfsEncryptPagingFile -Type DWord -Data 1
Start-Sleep 1
...
# The following lines are for clean-up and compaction purposes. They could take hours and degrage performance.
